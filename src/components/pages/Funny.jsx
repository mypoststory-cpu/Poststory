...
// 1. Added Firebase Firestore imports
...
export default function FunnyPage() {
  ...
  // 2. Updated Fetching logic to use Firebase
  useEffect(() => {
    const fetchImages = async () => {
      setLoading(true);
      try {
        // Query looks for documents where category is "Funny"
        const q = query(
  ...
  // 3. Updated Filter logic for Firestore data structure
